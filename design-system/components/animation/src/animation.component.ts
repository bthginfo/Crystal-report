...
import styles from './TsAnimationStyles.js';
import type { CSSResultGroup } from 'lit';

/**
 * @summary Animate elements declaratively with nearly 100 baked-in presets, or roll your own with custom keyframes. Powered by the [Web Animations API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Animations_API).
 * @documentation https://create.tuvsud.com/latest/components/animation/develop-TirkfTLs
 * @status stable
 * @since 1.0
 *
 * @event ts-cancel - Emitted when the animation is canceled.
 * @event ts-finish - Emitted when the animation finishes.
 * @event ts-start - Emitted when the animation starts or restarts.
 *
 * @slot - The element to animate. Avoid slotting in more than one element, as subsequent ones will be ignored. To
 *  animate multiple elements, either wrap them in a single container or use multiple `<ts-animation>` elements.
 */
export default class TsAnimationComponent extends ComponentElement {
