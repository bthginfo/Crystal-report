...
import styles from './TsImageComparerStyle.js';
import type { CSSResultGroup } from 'lit';
import { LocalizeController } from '../../../utils/internal/localize.js';

/**
 * @summary Compare visual differences between similar photos with a sliding panel.
 * @documentation https://create.tuvsud.com/latest/components/image-comparer/develop-h0GU9Eig
 * @status stable
 * @since 1.0
 *
 * @dependency ts-icon
 ...
 *
 * @event ts-change - Emitted when the position changes.
 *
 ...
 */
export default class TsImageComparerComponent extends ComponentElement {
    static override styles: CSSResultGroup = [componentStyles, styles];
    static scopedElement = { 'ts-icon': TsIcon };
        ...
        return html`
            ...
            >
                ...
                >
                    ...
                    >
                        <slot name="handle">
                            <ts-icon library="system" name="grip-vertical"></ts-icon>
                        </slot>
                    </div>
                </div>
            </div>
