...
import { getTextContent, HasSlotController } from '../../../utils/internal/slot.js';
...
import styles from './TsMenuItemStyles.js';
import type { CSSResultGroup } from 'lit';
import { SlotTextNormalizeController } from '../../../utils/slots/SlotTextNormalizeController.js';

/**
 * @summary Menu items provide options for the user to pick from in a menu.
 * @documentation https://create.tuvsud.com/latest/components/menu-item/develop-gRTzMFGa
 * @status stable
 * @since 1.0
 *
 * @dependency ts-icon
 ...
 */
export default class TsMenuItemComponent extends ComponentElement {
        ...
        return html`
            ...
            >
                <span part="checked-icon" class="menu-item__check">
                    <ts-icon name="check" library="system" aria-hidden="true"></ts-icon>
                </span>
                ...
                ${this.loading ? html` <ts-spinner part="spinner" exportparts="base:spinner__base"></ts-spinner> ` : ''}
            </div>
        `;
    }
}
