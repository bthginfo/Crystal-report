...
import styles from './TsRelativeTimeStyle.js';

/**
 * @summary Outputs a localized time phrase relative to the current date and time.
 * @documentation https://create.tuvsud.com/latest/components/relative-time/develop-Bo7JxFEY
 * @status stable
 * @since 1.0
 */
...
export default class TsRelativeTimeComponent extends ComponentElement {
    ...
    override render() {
        ...
        return html` <time class="relative-time" datetime=${this.isoTime}>${this.relativeTime}</time> `;
    }
}
