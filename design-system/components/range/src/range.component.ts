...
import styles from './TsRangeStyles.js';
 ...
 * @documentation https://create.tuvsud.com/latest/components/range-slider/develop-pKmOGpVC
 * @status stable
 * @since 1.0
 *
 ...
 * @cssproperty --thumb-color - The color of the thumb (background and border).
 * @cssproperty --thumb-color-hover - The color of the thumb on hover.
 * @cssproperty --thumb-color-active - The color of the thumb when active.
 ...
 */
export default class TsRangeComponent extends ComponentElement implements ComponentFormControl {
    ...
    /**
     * The range's aria-label. If the range has a label (i.e. label prop or slot), this attribute is ignored.
     */
