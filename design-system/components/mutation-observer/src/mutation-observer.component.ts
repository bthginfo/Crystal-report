...
import styles from './TsMutationObserverStyle.js';
import type { CSSResultGroup } from 'lit';

/**
 * @summary The Mutation Observer component offers a thin, declarative interface to the [`MutationObserver API`](https://developer.mozilla.org/en-US/docs/Web/API/MutationObserver).
 * @documentation https://create.tuvsud.com/latest/components/mutation-observer/develop-Pl5ZJwJM
 * @status stable
 * @since 1.0
 *
 * @event {{ mutationList: MutationRecord[] }} ts-mutation - Emitted when a mutation occurs.
 *
 * @slot - The content to watch for mutations.
 */
export default class TsMutationObserverComponent extends ComponentElement {
