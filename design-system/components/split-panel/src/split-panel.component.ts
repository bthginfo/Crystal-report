...
import styles from './TsSplitPanelStyle.js';
import type { CSSResultGroup } from 'lit';
import { SlotTextNormalizeController } from '../../../utils/slots/SlotTextNormalizeController.js';

/**
 * @summary Split panels display two adjacent panels, allowing the user to reposition them.
 * @documentation https://create.tuvsud.com/latest/components/split-panel/develop-3xH2JeZT
 * @status stable
 * @since 1.0
 *
 * @event ts-reposition - Emitted when the divider's position changes.
 *
...
/** Used by ts-split-panel to convert an input position into a snapped position. */
...
export default class TsSplitPanelComponent extends ComponentElement {
