...
export class LocalizeController extends DefaultLocalizationController<Translation> {
    ...
    // This is basically some extra assurance that our translations get registered prior to
    // our localizer connecting in a component and we don't rely on implicit import ordering.
    static {
